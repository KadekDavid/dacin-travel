        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {galleryItems.map((item, index) => (
            <article
              ...
              className={`group relative min-h-[280px] overflow-hidden rounded-[26px] bg-[#eef3ff] shadow-[0_22px_54px_rgba(15,23,42,0.08)] ${
            ...
            >
              ...
              <div className="absolute bottom-5 left-5 right-5">
                <span className="inline-flex rounded-full bg-white/90 px-3 py-1.5 text-xs font-bold uppercase tracking-wide text-[#0046FF]">
                  {item.category}
                </span>
